#!/usr/bin/env python3
"""
ACET College Dashboard Generator
  ...
  <div class="card">
    <div class="tbl-wrap">
      <table>
        ...
        <tbody>
          <tr>
            <td class="td-name">MBA</td>
            <td>₹ 85,000</td>
            <td>₹ 80,000</td>
            <td class="td-na">—</td>
            <td class="td-na">—</td>
            <td class="td-total">₹ 1,65,000</td>
          </tr>
          <tr>
            <td class="td-name">MCA</td>
            <td>₹ 90,000</td>
            <td>₹ 85,000</td>
            <td class="td-na">—</td>
            <td class="td-na">—</td>
            <td class="td-total">₹ 1,75,000</td>
          </tr>
          <tr>
            <td class="td-name">B.Tech</td>
            <td>₹ 1,10,000</td>
            <td>₹ 1,05,000</td>
            <td>₹ 1,00,000</td>
            <td>₹ 1,00,000</td>
            <td class="td-total">₹ 4,15,000</td>
          </tr>
          <tr>
            <td class="td-name">BBA</td>
            <td>₹ 60,000</td>
            <td>₹ 55,000</td>
            <td>₹ 55,000</td>
            <td class="td-na">—</td>
            <td class="td-total">₹ 1,70,000</td>
          </tr>
          <tr>
            <td class="td-name">BCA</td>
            <td>₹ 65,000</td>
            <td>₹ 60,000</td>
            <td>₹ 60,000</td>
            <td class="td-na">—</td>
            <td class="td-total">₹ 1,85,000</td>
          </tr>
        </tbody>
      </table>
    </div>
...
function sendMsg() {
  ...
  setTimeout(() => document.getElementById('qSuccess').style.display = 'none', 3500);
}
...
sections = [
    "1. College Overview",
    "2. Departments (MBA, MCA, B.Tech, BBA, BCA)",
    "3. Admission Procedure + Documents Required",
    "4. Fees Structure (year-wise table)",
    "5. Academic Calendar 2026 (all months)",
    "6. Circular — Notices (5) + Events (6)",
    "7. Contact Us (address, email, 7 numbers, quick message form)",
]
for s in sections:
    print(f"   ✅ {s}")
